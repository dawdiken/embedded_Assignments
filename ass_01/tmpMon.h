...
typedef void(*Operation)(const struct distance  *const tempvalues);//function pointer called Operation
...
void printMeBaby(const struct distance *const tempvalues);
